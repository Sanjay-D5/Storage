  ...
  return (
    <>
        ...
        <AlertDialogContent className="shad-alert-dialog">
            ...
            <AlertDialogTitle className="h2 text-center">Enter Tour OTP
                <img src="/assets/icons/close-dark.svg" alt="close" height={20} width={20} onClick={() => setIsOpen(false)} className="otp-close-button"/>
            </AlertDialogTitle>
