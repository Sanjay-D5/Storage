...
// Define the interface for TotalSpace
...
const Dashboard = () => {
  ...
  const [totalSpace, setTotalSpace] = useState<TotalSpace>({ used: 0 }); // Initialize with correct structure
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    const fetchData = async () => {
      const [fetchedFiles, fetchedTotalSpace] = await Promise.all([
